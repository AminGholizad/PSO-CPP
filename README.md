...
3. The cost function signature should be one array/vector of doubles as input and the output is a cost type of an array of doubles representing objective and a double representing infeasablity of the problem.
